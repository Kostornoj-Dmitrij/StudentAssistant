...
class LLMClient:
    ...
    async def generate_answer(self, question: str, context: List[Dict[str, Any]]) -> str:
        ...
        try:
            ...
            ИНСТРУКЦИИ:
            1. В первую очередь используй информацию из базы знаний
            2. Если информации для полного ответа недостаточно, Ответь на основе своих знаний о проектном обучении, Agile, Scrum и управлении проектами.
